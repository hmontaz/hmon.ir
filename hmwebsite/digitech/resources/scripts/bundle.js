...
class UIHandler {
    constructor() {
        ...
        this.base = 0;
        this.mode = 0;
        this.outputCommand = 1;
        this.outputId = 'output-1';
        this.outputChannel = 0;
        this.midiOutputs = [];
        this.list_0 = ['-OCT,+OCT', '-5TH,-4TH', '-4TH,-3RD', '+5TH,+7TH', '+5TH,+6TH', '+4TH,+5TH', '+3RD,+4TH', '+♭3RD,+3RD', '+2ND,+3RD', null, 'SHALLOW'];
        this.list_1 = ['+2 OCT', '+ OCT', '+ 5TH', '+ 4TH', '- 2ND', '- 4TH', '- 5TH', '- OCT', '- 2OCT', 'DIVE BOMB', 'DEEP'];
        this.list_dt_0 = ['1', '2', '3', '4', '5', '6', '7', '<tiny><br><br><sup>OCT</sup><br></tiny>', '<tiny><sup>OCT</sup><br>&#43;<br><sup>DRY</sup></tiny>'];
        this.list_dt_1 = ['1', '2', '3', '4', '5', '6', '7', '<tiny><sup>OCT</sup><br><br></tiny><br>', '<tiny><sup>OCT</sup><br>&#43;<br><sup>DRY</sup><br><br></tiny>'];
        var _this = this;
        this.midi = new MIDI();
        this.midi.init(() => {
    ...
    updateDisplay(valueOn, valueOff) {
    ...
    fill_dt(list, cssClass, target, getName, dir) {
    ...
    fillColumn(list, cssClass, target, getName, dir) {
        let skipped = 0;
        list.forEach((item, i) => {
